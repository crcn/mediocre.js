...
(function() {
  var Mediator, Message, async, bindableCall, factory, listenerCollection, type,
    __slice = [].slice;
  ...
  Mediator = (function() {
    ...
    */
    ...
    Mediator.prototype.execute = function(nameOrMessage, data, next) {
      ...
      call = bindableCall(function(next) {
      ...
      call.bind("response").once().to(function(response) {
        return next(response.error, response.data);
      }).now();
      return call;
    };
